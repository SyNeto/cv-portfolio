...
export const Sidebar: React.FC<SidebarProps> = ({ className = '' }) => {
  const { navigation, social, getAllSectionIds } = usePortfolioData();
        ...
        <nav className="flex flex-col space-y-6" aria-label="Page sections">
          ...
          >
            <a
              ...
              className="text-gray-600 hover:text-gray-900 hover:scale-110 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-opacity-50 rounded p-1"
